...
import { ShieldCheck, Cpu, HardDrive, Network } from 'lucide-react';
      ...
      <section className="relative py-20 bg-black overflow-hidden border-b border-zinc-900">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-zinc-400 font-light max-w-3xl mx-auto leading-relaxed text-base sm:text-lg">
            Aurelius Capital pairs statistical currency strategies with next-generation institutional execution infrastructure. Learn how we onboarding, execute, and safeguard capital.
          </p>
        </div>
      </section>
